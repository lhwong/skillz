package com.skillzstreet.talentspy.master.config;
...
@EnableJpaRepositories(basePackages = { "com.skillzstreet.talentspy.master.entity",
        "com.skillzstreet.talentspy.master.repository" }, entityManagerFactoryRef = "masterEntityManagerFactory", transactionManagerRef = "masterTransactionManager")
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory() {
        ...
        em.setPackagesToScan(
                new String[] { Tenant.class.getPackage().getName(),
                        TenantRepository.class.getPackage().getName() });
